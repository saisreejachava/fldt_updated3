...
import { NavMegaMenuPanel, NavMegaMenuTriggers, useNavMegaMenu } from './NavMegaMenu'
...
export function SiteNavbar() {
  ...
  return (
    <header className="site-shell-nav site-shell-nav--floating">
      <div
        ref={navWrapRef}
        className="site-shell-nav__wrap"
      ...
      >
        <div className="site-shell-nav__pill">
          ...
          >
            <NavMegaMenuTriggers mega={mega} onNavigate={close} mobileDrawerOpen={open} />
            <NavLink
              to="/resources"
        ...
        {mega.openGroup ? (
          <NavMegaMenuPanel
            anchorRef={navWrapRef}
            group={mega.openGroup}
            onClose={mega.scheduleClose}
            onCancelClose={mega.cancelClose}
            onNavigate={close}
          />
        ) : null}
      </div>
